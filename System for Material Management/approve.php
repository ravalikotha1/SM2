...
echo"<tr>";
	...
	echo"
	   <div class = \"row\">
   <div class = \"col-lg-1\">
 <a href = \"http://localhost/adbmsscripts/result.php?varname1=approve\">
 			  <button id=\"rej\" type=\"submit\"> Approve</button>
			  </a>
 
   </div>
  <div class=\"col-lg-1\"> </div>
      <div class = \"col-lg-1\">
	  <a href = \"http://localhost/adbmsscripts/result.php?varname1=reject\">
 			  <button id=\"rej\" type=\"submit\"> Reject </button>
			  </a>
 			</div>
 			</div>";
